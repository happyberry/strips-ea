...
char *problemName = "FIFTEEN";
char *actionName[] = { "MOVETOBLOCK2", "MOVETOBLOCK1", "MOVETOTABLE", NULL };

char *objectName[] = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", NULL };
...
{
  return( sit[1].lit && sit[2].lit && sit[3].lit && sit[4].lit && sit[5].lit && sit[6].lit && sit[7].lit && sit[8].lit && sit[9].lit && sit[10].lit && sit[11].lit );
}
