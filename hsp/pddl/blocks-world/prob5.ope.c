...
int goalAtoms[] = { 1 /* (ON L B) */, 2 /* (ON B C) */, 3 /* (ON C P) */, 4 /* (ON P K) */, 5 /* (ON K G) */, 6 /* (ON O M) */, 7 /* (ON M H) */, 8 /* (ON H I) */, 9 /* (ON I D) */, 10 /* (ON Q R) */, 11 /* (ON R S) */, 12 /* (ON S N) */, 13 /* (ON N A) */, 14 /* (ON A E) */, 15 /* (ON E J) */, 0 };
